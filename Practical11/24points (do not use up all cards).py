...
def calculate(numbers):
    global found
    global times
    if numbers[len(numbers)-1]>23.999 and numbers[len(numbers)-1]<24.001:
        #because division may cause deviation, the number after calculation will always be the last
        found=True
        return
    if len(numbers)==1:
        return
